...
kernel_ = 'linear'
gamma_ = 10
model = SVC(C=c_, kernel=kernel_, gamma=gamma_)
...
print('C = {}, kernel = {}, gamma = {},cross-validation average = {:.4}'.format(c_, kernel_, gamma_,average_score))
